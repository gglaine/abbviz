...
const Sidebar: React.FC<SidebarProps> = ({ isOpen }) => {
  return (
    <div className={`sidebar ${isOpen ? 'expanded' : 'collapsed'}`} style={{ width: isOpen ? '230px' : '50px', transition: 'width 0.3s ease-in-out', position: 'fixed', left: 0, top: 0, height: '100vh', overflowY: 'auto' }}>
